...
export MASTER_PORT=8800
# The rank of this worker, should be in {0, ..., WORKER_CNT-1}, for single-worker training, please set to 0
export RANK=0 

export PYTHONPATH=${PYTHONPATH}:`pwd`/cn_clip/

DATAPATH="/home/dengyiru/Chinese-CLIP-master/data_path"

# data options
train_data=${DATAPATH}/datasets/aug_vip/lmdb/train
val_data=${DATAPATH}/datasets/farfetch/lmdb/valid # if val_data is not specified, the validation will be automatically disabled
...
name=vip_finetune_vit-b-16_roberta-base_bs128_4gpu
